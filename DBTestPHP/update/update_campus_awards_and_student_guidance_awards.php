...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE campus_awards_and_student_guidance_awards SET award_name='$award_name', launch_year='$launch_year', awarding_unit='$awarding_unit', awarding_date='$awarding_date', content='$content' WHERE ID='$ID'";
